...
2. **EraCategory (시대 구분) - 반드시 아래 순서대로 판정**
   **판정 순서:**
   1. 이미지의 전체적인 분위기·환경·건축물·의상·소품 등을 통합적으로 평가
   2. 장면의 주된 맥락을 전통/현대 중 어느 쪽이 더 강하게 규정하는지 판단
   3. 아래 기준에 따라 전통(1)·현대(2)·혼합(3)·기타(4) 중 하나를 선택

**분류 기준:**
**전통(1)**: 전통적 요소들이 화면 전체를 일관되게 지배하는 경우
- 전통 건축물(한옥, 사찰, 성곽), 전통 의상(한복, 갑옷), 전통 소품만 명확히 보이는 경우
- 장면 자체가 사극·전통 문화 재현이라는 느낌이 분명한 경우

**현대(2)**: 현대적 환경이 화면 전체를 명확하게 지배하는 경우
- 현대 건축물, 도로, 가구, 차량, 전자기기 등 현대적 사물·공간이 중심인 경우
- 의상·소품도 현대적 요소가 압도적으로 많은 경우

**혼합(3)**: 전통과 현대가 모두 ‘명확하게’ 인지되어 장면을 단독으로 분류하기 어려운 경우
- 전통 건축물 + 현대 소품,의상,물건
- 전통 복장 + 현대 복장 
- 현대 배경 + 전통 소품, 의상, 물건
 화면의 10% 이상을 차지하는 현대적 사물 또는 구조물이 존재할 때
- 인물 주변에 현대적 가구·소품이 명확히 보일 때
- 바퀴·스테인리스·플라스틱 등 현대 제작 방식이 뚜렷한 경우
- 전통 공간에 현대적 촬영 장비·조명·행거·의류 보관대 등이 포함될 때
