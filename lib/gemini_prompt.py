...
1. **정경 설명 (SceneExp)**
   - 장소, 환경, 분위기를 묘사
   - 종결 어미: **~분위기이다.**
   - 예시: "넓은 해변이 곧게 펼쳐지고 그 뒤로 고층 건물들이 줄지어 서 있는 도시 해안 풍경이 밝고 여유로운 분위기이다."
...
1. **정경 (SceneExp) - 우선 보완**
   - 부족: "해변과 건물이 보이는 분위기이다." (5어절)
   - 충분: "넓은 해변이 곧게 펼쳐지고 그 뒤로 고층 건물들이 줄지어 서 있는 도시 해안 풍경이 밝고 여유로운 분위기이다." (18어절)
...
1. SceneExp: "넓은 해변이 곧게 펼쳐지고 그 뒤로 고층 건물들이 줄지어 서 있는 도시 해안 풍경이 밝고 여유로운 분위기이다." (18어절)
...
1. SceneExp: "실내 레스토랑에서 한 명의 셰프가 큰 철판 위에서 요리하고 있으며, 손님들이 이를 지켜보는 활기찬 분위기이다." (17어절)
...
1. SceneExp: "푸른 하늘과 바다를 배경으로 여러 명의 여성들이 요트 위에서 즐거운 시간을 보내는 활기찬 분위기이다." (17어절)
...
{{
  "meta": {{
    "width": {image_metadata['width'] if image_metadata else '[width]'},
    "height": {image_metadata['height'] if image_metadata else '[height]'},
    "format": "{image_metadata['format'] if image_metadata else '[format]'}"
  }},
  "category_info": {{
    "LocationCategory": 2,
    "EraCategory": 2
  ...
  "annotation_info": {{
    "SceneExp": "넓은 해변이 곧게 펼쳐지고 그 뒤로 고층 건물들이 줄지어 서 있는 도시 해안 풍경이 밝고 여유로운 분위기이다.",
    ...
    "Explanation": "넓은 해변이 곧게 펼쳐지고 그 뒤로 고층 건물들이 줄지어 서 있는 도시 해안 풍경이 밝고 여유로운 분위기이다. 밝은 모래빛과 짙푸른 바다가 어우러진 명료한 색감이다. 높은 시점에서 내려다보는 항공 구도이다. 해변 곳곳에는 사람들이 여유롭게 걸으며 휴식을 즐기고 있다. 유리 외벽이 반짝이는 고층 건물들이 빽빽하게 늘어서 있다."
  }}
}}
"""
